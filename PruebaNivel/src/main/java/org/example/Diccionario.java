...
public class Diccionario {
    ...
    public static void menu(Diccionario diccionario){
        diccionario.leerDiccionario("C:/Users/jegza/eclipse-workspace/PruebaNivel/src/main/java/org/example/palabras.csv");
        //La ruta del archivo varía según la ubicación del mismo en su computadora
